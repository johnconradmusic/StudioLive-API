...
namespace Presonus.StudioLive32.Api
{
	public class RawService
	{
		...
		public StudioLive32R Device { get; set; }
		...
		{
			if (!route.Contains("meter") && !route.Contains("reduction"))
		...
		public void SetValue(string route, float value)
		{
			...
			//Serilog.Log.Information("Set Value: " + route + " - " + value);
		...
		public void JSON()
		{
			// var sceneFile = File.ReadAllText("C:\\Dev\\new-scene.scn"); SyncronizeState(sceneFile);
		}
