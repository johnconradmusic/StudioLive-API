...
namespace Presonus.StudioLive32.Wpf.UserControls
{
	public partial class RotaryKnobControl : UserControl
	{
		...
		public static readonly DependencyProperty NameProperty =
							DependencyProperty.Register("Name", typeof(string), typeof(RotaryKnobControl));
		...
		{
			double angleRange = 300; // The range of angles (in degrees) between 30 and 330
			double angleOffset = 30; // The offset angle (in degrees) for the minimum value
