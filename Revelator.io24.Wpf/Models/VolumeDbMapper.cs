...
namespace Revelator.io24.Wpf.Models
{
    public class VolumeDbMapper
    {
        ...
        public float CH1 { get => GetValue(Input.CH1, MixOut.Main); set => SetValue(Input.CH1, MixOut.Main, value); }
        public float CH2 { get => GetValue(Input.CH2, MixOut.Main); set => SetValue(Input.CH2, MixOut.Main, value); }
        public float CH3 { get => GetValue(Input.CH3, MixOut.Main); set => SetValue(Input.CH3, MixOut.Main, value); }
        public float CH4 { get => GetValue(Input.CH4, MixOut.Main); set => SetValue(Input.CH4, MixOut.Main, value); }
        public float CH5 { get => GetValue(Input.CH5, MixOut.Main); set => SetValue(Input.CH5, MixOut.Main, value); }
        ...
        private float GetValue(Input input, MixOut mixOut)
            => _routingTable.GetVolumeInDb(input, mixOut);

        private void SetValue(Input input, MixOut mixOut, float value)
            => _routingTable.SetVolumeInDb(input, mixOut, value);
    }
}
