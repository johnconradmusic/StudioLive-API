...
//        public float type { get => GetFloat(); set => SetValue(value); }
...
//        public float feedback { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/lpf")]
//        public float lpf { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/hpf")]
//        public float hpf { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/fb_lpf")]
//        public float fb_lpf { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/fb_hpf")]
//        public float fb_hpf { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/delay_l")]
//        public float delay_l { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/delay_r")]
//        public float delay_r { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/fb_l")]
//        public float fb_l { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/fb_r")]
//        public float fb_r { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/spread")]
//        public float spread { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/fb_l_lpf")]
//        public float fb_l_lpf { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/fb_l_hpf")]
//        public float fb_l_hpf { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/fb_r_lpf")]
//        public float fb_r_lpf { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/fb_r_hpf")]
//        public float fb_r_hpf { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/dly_offset_l")]
//        public float dly_offset_l { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/dly_offset_r")]
//        public float dly_offset_r { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/reflection")]
//        public float reflection { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/diffusion")]
//        public float diffusion { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/size")]
//        public float size { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/ratio")]
//        public float ratio { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/lfdamp_freq")]
//        public float lfdamp_freq { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/lfdamp_gain")]
//        public float lfdamp_gain { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/hfdamp_freq")]
//        public float hfdamp_freq { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/hfdamp_gain")]
//        public float hfdamp_gain { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/predelay")]
//        public float predelay { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/rate")]
//        public float rate { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/depth")]
//        public float depth { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/offset")]
//        public float offset { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/width")]
//        public float width { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/shape")]
//        public float shape { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/polarity")]
//        public bool polarity { get => GetBoolean(); set => SetBoolean(value); }

//        [ParameterPath("plugin/range")]
//        public float range { get => GetFloat(); set => SetValue(value); }

//        [ParameterPath("plugin/type")]
//        public float verbType { get => GetFloat(); set => SetValue(value); }
