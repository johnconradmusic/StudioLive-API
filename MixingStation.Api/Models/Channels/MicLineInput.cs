...
namespace MixingStation.Api.Models.Channels
{
    public class MicLineInput : InputChannel
    {
        ...
        [ParameterPath("preampgain")] public float trim { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("filter/hpf")] public float hpf { get => GetFloat(); set => SetValue(value); }
        [ParameterPath("opt/swapcompeq")] public bool swapcompeq { get => GetBoolean(); set => SetBoolean(value); }

        public float preampmode { get => GetFloat(); set => SetValue(value); }

        public List<string> preampmode_values = new List<string>() { "Pre", "Gain" };

        public bool preampState => preampmode == 0;
        ...
        [ParameterPath("gate/threshold")] public float gate_threshold { get => GetFloat(); set => SetValue(value); }
        [ParameterPath("gate/range")] public float gate_range { get => GetFloat(); set => SetValue(value); }
        [ParameterPath("gate/attack")] public float gate_attack { get => GetFloat(); set => SetValue(value); }
        [ParameterPath("gate/release")] public float gate_release { get => GetFloat(); set => SetValue(value); }
        [ParameterPath("gate/keyfilter")] public float gate_keyfilter { get => GetFloat(); set => SetValue(value); }
        ...
        public float eq_gain1 { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("eq/eqq1")]
        public float eq_q1 { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("eq/eqfreq1")]
        public float eq_freq1 { get => GetFloat(); set => SetValue(value); }
        ...
        public float eq_gain2 { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("eq/eqq2")]
        public float eq_q2 { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("eq/eqfreq2")]
        public float eq_freq2 { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("eq/eqbandon2")]
        public bool eq_bandon2 { get => GetBoolean(); set => SetBoolean(value); }

        [ParameterPath("eq/eqgain3")]
        public float eq_gain3 { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("eq/eqq3")]
        public float eq_q3 { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("eq/eqfreq3")]
        public float eq_freq3 { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("eq/eqbandon3")]
        public bool eq_bandon3 { get => GetBoolean(); set => SetBoolean(value); }

        [ParameterPath("eq/eqgain4")]
        public float eq_gain4 { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("eq/eqq4")]
        public float eq_q4 { get => GetFloat(); set => SetValue(value); }

        [ParameterPath("eq/eqfreq4")]
        public float eq_freq4 { get => GetFloat(); set => SetValue(value); }
        ...
        [ParameterPath("comp/threshold")] public float comp_threshold { get => GetFloat(); set => SetValue(value); }
        [ParameterPath("comp/ratio")] public float comp_ratio { get => GetFloat(); set => SetValue(value); }
        [ParameterPath("comp/attack")] public float comp_attack { get => GetFloat(); set => SetValue(value); }
        [ParameterPath("comp/release")] public float comp_release { get => GetFloat(); set => SetValue(value); }
        [ParameterPath("comp/gain")] public float comp_gain { get => GetFloat(); set => SetValue(value); }
        [ParameterPath("comp/keyfilter")] public float comp_keyfilter { get => GetFloat(); set => SetValue(value); }
        ...
        [ParameterPath("limit/threshold")] public float limiter_threshold { get => GetFloat(); set => SetValue(value); }
